...
** DONE Building Emacs from source :emacs:
...
** DONE Upgrading an outdated Hugo template
...
worked in my case. By replacing /Page.URL/ with /Params.URL/ everything worked
